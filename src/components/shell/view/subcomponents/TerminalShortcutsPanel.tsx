...
const KEY_BTN =
  'shrink-0 rounded-md border border-border bg-muted px-2.5 py-1.5 text-xs font-medium text-foreground transition-colors select-none active:bg-[var(--brand-accent)] active:text-white active:border-[var(--brand-accent)] disabled:cursor-not-allowed disabled:opacity-40';
const KEY_BTN_ACTIVE =
  'shrink-0 rounded-md border border-[var(--brand-accent)] bg-[var(--brand-accent)] px-2.5 py-1.5 text-xs font-medium text-white transition-colors select-none disabled:cursor-not-allowed disabled:opacity-40';
const ICON_BTN =
  'shrink-0 rounded-md border border-border bg-muted p-1.5 text-foreground transition-colors select-none active:bg-[var(--brand-accent)] active:text-white active:border-[var(--brand-accent)] disabled:cursor-not-allowed disabled:opacity-40';
