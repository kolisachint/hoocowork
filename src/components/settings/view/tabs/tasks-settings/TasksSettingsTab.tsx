              ...
              <div className="border-[var(--warn)]/20 bg-[var(--warn)]/5 dark:border-[var(--warn)]/20 dark:bg-[var(--warn)]/10 rounded-xl border p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="mb-2 font-medium text-foreground dark:text-foreground">
                    ...
                    <div className="space-y-3 text-sm text-muted-foreground dark:text-muted-foreground">
                      ...
                      <div>
                        <a
                          ...
                          className="inline-flex items-center gap-2 text-sm font-medium text-[var(--brand-accent)] hover:text-[var(--brand-accent)] dark:text-[var(--brand-accent)] dark:hover:text-[var(--brand-accent)]"
                        >
